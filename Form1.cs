    ...
    public partial class Form1 : Form
    {
        ...
        private void FormConstruct()
        {
            try
            {
                ...
                if (!File.Exists(Environment.CurrentDirectory + "\\gamedata.db_xxlocale") && File.Exists(Environment.CurrentDirectory + "\\localization\\" + lang + "\\gamedata.db_xxlocale"))
                    File.Copy(Environment.CurrentDirectory + "\\localization\\" + lang + "\\gamedata.db_xxlocale", Environment.CurrentDirectory + "\\gamedata.db_xxlocale", true);
        ...
        {
            // delete old locale
            File.Delete(Environment.CurrentDirectory + "\\gamedata.db_xxlocale");

            // copy new locale
            try
            {
                //   if (_l != E_LANG.RU)
                File.Copy(Environment.CurrentDirectory + "\\localization\\" + lang + "\\gamedata.db_xxlocale", Environment.CurrentDirectory + "\\gamedata.db_xxlocale");
            }
            catch (Exception e)
            {
                MessageBox.Show(e.Message);
